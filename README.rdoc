...
* Rails 3
* FreadyDazio's fork of awesome_nested_set for Rails 3 at https://github.com/FreakyDazio/awesome_nested_set.git
...
And then you can fire up your rails server and can navigate to /admin/context/
